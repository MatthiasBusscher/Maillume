...
export function ScannerPage({
  ...
  const marketingHref = getMarketingRouteHref(localizePath("/", locale));
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#eef1eb]">
      ...
      <section className="border-b border-[#aeb6ac] bg-[#f7f8f4]">
        <div className="mx-auto flex max-w-[1480px] flex-col gap-5 px-5 py-6 sm:px-6 sm:py-7 lg:flex-row lg:items-center lg:justify-between lg:gap-10 lg:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-3 font-mono text-[10px] uppercase text-[#087b72]">
              <span className="h-px w-8 bg-[#087b72]" aria-hidden="true" />
              {dictionary.app.audience}
            </div>
            <h1 className="mt-3 text-2xl font-semibold leading-tight text-[#111711] sm:text-3xl">
              {dictionary.app.workspaceTitle}
            </h1>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-[#4f5b50] sm:text-base">
              {dictionary.app.hero}
            </p>
          </div>

          <div className="flex shrink-0 flex-wrap gap-2 font-mono text-[10px] uppercase lg:justify-end">
            <div className="flex min-w-[154px] items-center gap-2 border border-[#aeb6ac] bg-white px-3 py-2.5">
              <Database className="h-4 w-4 flex-none text-[#087b72]" aria-hidden="true" />
              <div>
                <p className="text-[#59646f]">{dictionary.app.privacyStatus}</p>
                <p className="mt-0.5 font-sans text-sm font-semibold normal-case text-[#26313b]">
                  {dictionary.app.privacyValue}
                </p>
              </div>
            </div>
            <div className="flex min-w-[140px] items-center gap-2 border border-[#aeb6ac] bg-white px-3 py-2.5">
              <ScanSearch className="h-4 w-4 flex-none text-[#d76b16]" aria-hidden="true" />
              <div>
                <p className="text-[#59646f]">{dictionary.app.assessmentStatus}</p>
                <p className="mt-0.5 font-sans text-sm font-semibold normal-case text-[#26313b]">
      ...
      <footer className="border-t border-[#aeb6ac] bg-[#f7f8f4]">
        <div className="mx-auto flex max-w-[1480px] flex-col gap-4 px-5 py-5 text-xs leading-5 text-[#59646f] sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            ...
            <p className="mt-1 font-mono text-[10px] uppercase text-[#59646f]">
