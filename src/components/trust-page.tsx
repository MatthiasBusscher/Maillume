...
export function TrustPage({ children, description, eyebrow, title }: { children: ReactNode; description: string; eyebrow: string; title: string }) {
  return (
    <main className="min-h-screen bg-[#f7f8f4]">
      ...
      <header className="border-b border-[#aeb6ac] bg-white">
        <div className="mx-auto max-w-5xl px-5 py-16 sm:px-6 sm:py-20">
          ...
          <p className="mt-5 font-mono text-[10px] uppercase text-[#778177]">Last updated: July 10, 2026</p>
        </div>
      </header>
