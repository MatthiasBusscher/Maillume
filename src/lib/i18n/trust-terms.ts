...
export const trustTermsCopy = {
  en: {
    ...
    sections: {
      ...
      accounts: { title: "Accounts", paragraphs: ["The public beta scanner does not require or currently offer accounts, sign-in, or integration API keys. Maillume will announce optional account features only after their production security and email-delivery checks pass."] },
  ...
  nl: {
    ...
    sections: {
      ...
      accounts: { title: "Accounts", paragraphs: ["Voor de publieke betascanner is geen account, inloggen of integratie-API-sleutel nodig of beschikbaar. Maillume kondigt optionele accountfuncties pas aan nadat de productiecontroles voor beveiliging en e-mailbezorging zijn geslaagd."] },
