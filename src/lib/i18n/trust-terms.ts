...
export const trustTermsCopy = {
  en: {
    ...
    sections: {
      ...
      accounts: { title: "Optional accounts", paragraphs: ["The public beta scanner remains available without an account. Sign-in and integration API keys are optional and are subject to the authentication, security, quota, and deletion controls described in the privacy notice."] },
  ...
  nl: {
    ...
    sections: {
      assessment: { title: "Geautomatiseerde beoordeling", paragraphs: ["Maillume geeft een geautomatiseerde risicobeoordeling op basis van beschikbare berichttekst en technische patronen. De dienst garandeert niet dat een e-mail veilig, kwaadaardig, authentiek of frauduleus is.", "Je blijft zelf verantwoordelijk voor de beslissing om te klikken, antwoorden, betalen, informatie te delen, een bericht te melden of via een vertrouwd kanaal contact op te nemen met de vermeende afzender."] },
      use: { title: "Toegestaan gebruik", items: ["Gebruik Maillume niet voor phishing, spam, fraude, intimidatie, verspreiding van malware of ongeautoriseerde toegang.", "Dien geen inhoud in die je niet mag verwerken.", "Probeer geen limieten te omzeilen, de dienst te overbelasten of sessies van andere gebruikers te onderzoeken.", "Gebruik synthetische of volledig opgeschoonde voorbeelden in openbare issues en bijdragen."] },
      accounts: { title: "Optionele accounts", paragraphs: ["De publieke betascanner blijft zonder account beschikbaar. Inloggen en integratie-API-sleutels zijn optioneel en vallen onder de authenticatie-, beveiligings-, quota- en verwijderingsmaatregelen uit de privacyverklaring."] },
