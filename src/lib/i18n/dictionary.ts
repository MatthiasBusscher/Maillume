...
export const dictionaries = {
  en: {
    app: {
      ...
      privacyStatus: "Scan history turned off",
      privacyValue: "Not stored",
    ...
    form: {
      ...
      privacyNote:
        "Processed once for this assessment. Your scan content is not stored.",
  ...
  nl: {
    ...
    form: {
      ...
      privacyNote:
        "Eenmalig verwerkt voor deze beoordeling. De scaninhoud wordt niet opgeslagen.",
