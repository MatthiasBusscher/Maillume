...
The task pane requires the `analysis-v2.1` classification and score-factor breakdown, verifies detected links and the factor total, and explains that the score is a risk index rather than a probability.
