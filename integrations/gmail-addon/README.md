...
The official manifest permits requests only to `https://app.maillume.io/`. A self-hosted operator must change `MAILLUME_ENDPOINT` and `urlFetchWhitelist`, then publish their own add-on deployment.
